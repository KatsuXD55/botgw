...
global.sig1 = 'https://wa.me/6285878178292?text=_Assalamualaikum+🙏🏻_'
global.sig = 'https://www.instagram.com/katsubotz_offical'
global.sgh = 'https://github.com/KatsuXD55'
global.sgc = 'https://chat.whatsapp.com/IXdaLd6tPjj7WaRga5yj93'
global.sdc = 'https://youtube.com/@katsuxdofficial'
global.snh = 'https://youtube.com/@katsuxdofficial'

/*============== PAYMENT ==============*/
global.pdana = '6285878178292' //Nomor dana atay gooay kalian
global.povo = '6285878178292' 
global.pgopay = '6285878178292'
global.ppulsa = '6285878178292' // Indosat : kalau gada diganti tanda - aja
global.ppulsa2 = '-' // tri : kalau gada diganti tanda - aja
global.psaweria = 'https://saweria.com'

/*============== NOMOR ==============*/
global.nomorbot = '6285878178292'
global.nomorown = '6285878178292' // nomor owner
global.namebot = 'HAYAKUY BOT'
global.nameown = 'KatsuXD Official'


/*============== STAFF ==============*/
global.owner = [
  ['6285878178292', 'Katsu', true],//Ganti jd nomormu sama Namamu dan tanda ( ' ) jangan di hapus', 'Zenz', true],//Ganti jd nomormu sama Namamu dan tanda ( ' ) jangan di hapus
  ['6285878178292', 'Developer Bot', true] //Jangan di Ganti🚫
  ]
...
/*============== WATERMARK ==============*/
global.wm = 'HAYAKUY BOT'
global.botdate = `\n© HAYAKUY BOT - ${week}, ${date}\n`//⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}, ${week}, ${date}
global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `WhatsApp Bot | By KatsuXD Official`
global.author = '\n© KatsuXD Official'


/*============== LOGO ==============*/
global.thumb = './katsu/katsu.png' //Main Thumbnail
global.imagebot = './katsu/logo.png'
global.giflogo = './katsu/gift.mp4'
...
/*============== STICKER WM ==============*/
global.stickpack = 'HAYAKUY BOT'
global.stickauth = `By @Katsuu`
